...
module.exports = {
	...
	mapSetName: function(string) {
		switch (string) {
			...
			case 'Set 005 Booster Pack':
				return 'Herofall Booster Pack';
			case 'Set 005 Primal Pack':
				return 'Herofall Primal Pack';
			case 'Set 006 Booster Pack':
				return 'Scars of War Booster Pack';
			case 'Set 006 Primal Pack':
				return 'Scars of War Primal Pack';
			case 'Set 007 Booster Pack':
				return 'Frostheart Booster Pack';
			case 'Set 007 Primal Pack':
				return 'Frostheart Primal Pack';
			case 'Set 008 Booster Pack':
				return 'Dead of Winter Booster Pack';
			case 'Set 008 Primal Pack':
				return 'Dead of Winter Primal Pack';
