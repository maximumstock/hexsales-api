...
module.exports = {
    ...
    parseSales: function(body, articleHashMap) {
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            if (parseInt(content[1].trim()) !== 0) {
                sale.type = 'Card';
            } else if (sale.name.match(/(Booster|Primal) Pack$/)) {
                sale.type = 'Pack';
    ...
    mapSetName: function(string) {
        switch(string) {
            case 'Set 001 Booster Pack': return 'Shards of Fate Booster Pack';
            case 'Set 001 Primal Pack': return 'Shards of Fate Primal Pack';
            case 'Set 002 Booster Pack': return 'Shattered Destiny Booster Pack';
            case 'Set 002 Primal Pack': return 'Shattered Destiny Primal Pack';
            case 'Set 003 Booster Pack': return 'Armies of Myth Booster Pack';
            case 'Set 003 Primal Pack': return 'Armies of Myth Primal Pack';
            case 'Set 004 Booster Pack': return 'Primal Dawn Booster Pack';
            case 'Set 004 Primal Pack': return 'Primal Dawn Primal Pack';
        }
    }
