...
module.exports = {
	...
	getSalesForDay: function(date) {
		return new Promise((resolve, reject) => {
			...
			const query = [
				'select distinct on (b.auction_id) b.plat_buyout, b.plat_bid, b.gold_buyout, b.gold_bid, b.item, a.created_at at time zone \'CET\' as created_at',
				'from auctions a, auctions b ',
				'where a.action = \'sold\' and date_trunc(\'day\', a.created_at at time zone \'CET\') = ? and a.auction_id = b.auction_id and b.action not in (\'sold\', \'post\')',
