...
router.get('/articles/:uuid', articleController.findByUUID);
router.get('/articles/:uuid/summaries', articleController.getSummary);
router.get('/articles/:uuid/histories', articleController.getHistory);
