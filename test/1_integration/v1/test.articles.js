...
describe('articles', function() {
  ...
  describe('GET /articles/:name/summaries', function() {
    ...
    it('should return summary-like stuff', function*() {
      ...
      props.forEach(function(p) {
        expect(result[p]).to.have.a.property('currency');
  ...
  describe('POST /articles/search', function() {
    ...
    it('should support searching by name', function*() {
      ...
      const res = yield request.post('/v1/articles/search').send({name: 'Vampire King'}).expect(200).expect('Content-Type', 'application/json; charset=utf-8').end();
      const result = res.body;
    ...
    it('should support searching by rarity', function*() {
      ...
      const res = yield request.post('/v1/articles/search').send({rarity: 'Epic'}).expect(200).expect('Content-Type', 'application/json; charset=utf-8').end();
      const result = res.body;
